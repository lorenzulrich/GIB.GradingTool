<?php
namespace GIB\GradingTool\ViewHelpers\Widget\Controller;
...
class PaginateController extends AbstractWidgetController {
	 ...
	 * @var integer
	 */
	protected $firstResultOfCurrentPage;

	/**
	 * @var integer
	 */
	protected $lastResultOfCurrentPage;
	...
	protected function buildPagination() {
		...
		$this->firstResultOfCurrentPage = ($this->currentPage * $this->configuration['itemsPerPage']) - ($this->configuration['itemsPerPage'] - 1);
		$this->lastResultOfCurrentPage = $this->currentPage * $this->configuration['itemsPerPage'] > $this->numberOfObjects ? $this->numberOfObjects : $this->currentPage * $this->configuration['itemsPerPage'];
		...
		$pagination = array(
			...
			'firstResultOfCurrentPage' => $this->firstResultOfCurrentPage,
			'lastResultOfCurrentPage' => $this->lastResultOfCurrentPage
		);
